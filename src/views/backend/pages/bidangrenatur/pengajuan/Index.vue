              ...
              >
                <template v-slot:default="{ active }">
                  <v-list-item-content>
                    ...
                    <v-list-item-sub-title>{{ item.opd }}</v-list-item-sub-title>
                    <v-list-item-sub-title>{{ item.tanggal }}</v-list-item-sub-title>
...
export default {
  ...
  created() {
    this.setPage({
      crud: true,
      dataUrl: "api/bidang-renatur/pengajuan",
      pagination: false,
  ...
  methods: {
    ...
    openFormVerifikasi: function (val) {
      this.$router.push({
        name: "bidang-renatur-pengajuan-verifikasi",
        params: {
          pengajuan_uuid: val,
          itemsPerPage: Number(this.table.options.itemsPerPage),
