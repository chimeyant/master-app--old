            ...
            >
              <template v-slot:activator="{ on }">
                ...
                >
                  <v-icon
                    color="white"
                    @click="$router.push({name:'bidang-data-pengajuan', params:{itemsPerPage: $route.params.itemsPerPage, page: $route.params.page}})"
  ...
  methods: {
    ...
    fetchRecord: async function () {
      let { data } = await this.http.get(
        "api/bidang-data/verifikasi/" + this.$route.params.pengajuan_uuid
      );
