          ...
          >
            ...
            <template v-slot:item.id="{ value }">
              ...
              >
                ...
                <v-list>
                  <v-list-item @click="openDaftarPeserta(value)">
                    <v-list-item-title>
                      <v-icon :color="theme.color">mdi-account-multiple</v-icon>
                      Daftar Peserta
                    </v-list-item-title>
                  </v-list-item>
                  <v-list-item @click="">
                    <v-list-item-title>
                      <v-icon :color="theme.color">mdi-email-edit</v-icon>
                      Buat Surat Tugas
                    </v-list-item-title>
                  </v-list-item>
...
export default {
  ...
  methods: {
    ...
    openDaftarPeserta: function (val) {
      this.$router.push({
        name: "bidang-bangrir-daftar-kegiatan-daftar-peserta",
        params: {
          kegiatan_uuid: val,
