      ...
      <v-col :cols="device.desktop ? `12` : `12`">
        <v-card class="animated animate__fadeInUp rounded-0">
            ...
            >
              <template v-slot:activator="{ on }">
                ...
                >
                  <v-icon
                    color="white"
                    @click="$router.push({name:'bidang-bangrir-daftar-kegiatan', params:{itemsPerPage: $route.params.itemsPerPage, page:$route.params.page}})"
          ...
          <v-data-table
            ...
            loading-text="Mohon menunggu..., sedang membuka data !"
      ...
      >
        <v-card class="rounded-0">
          ...
          <div :class="device.desktop ? ` `:``">
            <v-card-title class="justify-center">PILIH PESERTA</v-card-title>
...
export default {
  ...
  created() {
    this.setPage({
      crud: true,
      dataUrl:
        "api/bidang-bangrir/daftar-peserta/" + this.$route.params.kegiatan_uuid,
      pagination: false,
      title: "DAFTAR PESERTA",
      subtitle:
        "Berikut Daftar Seluruh Daftar Peserta Yang Tersedia Yang Tersedia",
      tableshow: true,
      breadcrumbs: [
        {
          text: "Daftar Peserta",
  ...
  methods: {
    ...
    postDeleteRecord: function (val) {
      this.postConfirmDelete(val).then(() => {});
    },
    ...
    fetchDataCalonPeserta: async function () {
      try {
        let { data } = await this.http.post(
          "api/bidang-bangrir/combo/daftar-calon-peserta"
        );
        this.daftarpesertas = data;
      } catch (error) {}
    },
  },
};
