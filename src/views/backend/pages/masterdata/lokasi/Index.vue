      ...
      >
        <v-card class="rounded-0">
          <v-toolbar
            ...
            :dark="theme.mode"
          >
            <v-icon class="mr-1">mdi-circle</v-icon> Formulir Pengaturan Lokasi
          </v-toolbar>
...
export default {
  ...
  created() {
    this.setPage({
      crud: true,
      dataUrl: "api/superadmin/master-data/lokasi",
      pagination: false,
      title: "MANAJEMEN LOKASI",
      subtitle: "Berikut Daftar Seluruh Lokasi Yang Tersedia",
      breadcrumbs: [
        {
