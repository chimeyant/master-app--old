  ...
  <div class="home pa-6 ">
    ...
    >
      ...
      <v-subheader class="text-h6">
        <h4>MANAJEMEN RAMBU</h4>
      </v-subheader>
    </v-flex>
    <v-flex class="pb-5 pl-7">
      <div class="grey--text mb-2">
        Seluruh Daftar Rambu Yang Tersedia
      </div>
    </v-flex>
              ...
              <template v-slot:activator="{ on }">
                ...
                >
                  <v-icon
                    ...
                    @click="$router.push({name:'master-jenis-rambu'})"
...
export default {
  ...
  created() {
    this.setPage({
      crud: true,
      dataUrl: "api/superadmin/master-data/rambu/"+ this.$route.params.jenis_rambu_uuid ,
      pagination: false,
      key:'uuid'
    })
    this.fetchRecords();
