...
export default {
  ...
  created() {
    this.setPage({
      crud: true,
      dataUrl: "api/superadmin/master-data/hotel",
      pagination: false,
      title: "MANAJEMEN HOTEL",
      subtitle: "Berikut Daftar Seluruh Hotel Yang Tersedia",
      breadcrumbs: [
        {
          text: "Manajemen Hotel",
          disabled: false,
          href: "hotel",
        },
        {
