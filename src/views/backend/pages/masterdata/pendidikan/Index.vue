...
export default {
  ...
  data: () => ({
    ...
    headers: [
      ...
      { text: "PENDIDIKAN", value: "name", align:'left', sortable:false,},
      { text: "SINGKAT", value: "singkat", align:'left', sortable:false, width:150},
  ...
  created() {
    this.setPage({
      crud: true,
      dataUrl: "api/master-data/pendidikan",
      pagination: false,
    })
    this.fetchRecords();
